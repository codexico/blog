---
title: "Tutorial simples parte 2: git branch e merge"
description: "Aprenda facilmente a utilizar branch e merge com git no github"
pubDate: "2010-11-16"
categories:
  - "git"
  - "linux"
...
A parte 1 ([Como usar o git e o github](http://codexico.com.br/blog/linux/tutorial-simples-como-usar-o-git-e-o-github)) foi sobre instalar o git, ssh-key, criar um projeto no github e os commits básicos.

Em projetos super simples tudo bem, mas para qualquer coisa maiorzinha já é melhor usar branchs, é fácil também, nem tirei o _simples_ do título do post.
...
Será usado o mesmo [repositório da parte 1](https://github.com/codexico/tutorial-github).
...
Foram criados dois commits, ambos no branch _parte2_, um push agora não irá alterar nada no repositório.
...
O formato é o seguinte _git push repositorioRemoto nomeLocalDoBranch:nomeRemotoDoBranch_, assim dá para enviar com um nome diferente se quiser.
...
Agora sim dá para ver que existe um branch, olha lá [https://github.com/codexico/tutorial-github/network](https://github.com/codexico/tutorial-github/network)
...
No final os merges ficaram assim: [![](images/merge.png "branches")](https://github.com/codexico/tutorial-github/network)
...
[Pro Git - Basic Branching and Merging](http://progit.org/book/ch3-2.html) [github - Working with remotes](http://help.github.com/remotes/) [nvie.com - A successful Git branching model](http://nvie.com/posts/a-successful-git-branching-model/)
